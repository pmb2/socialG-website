      ...
      <main>
        ...
        <section className="pt-20 pb-0 text-center">
          <div className="container mx-auto px-4">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-[48px] font-bold mb-8 bg-gradient-to-r from-[#FFA726] via-[#FF1681] via-[#C939D6] to-[#7B5DFF] text-transparent bg-clip-text mx-auto inline-block leading-none" style={{ lineHeight: '1' }}>
