...
export default function Page() {
  ...
  // Add state for contact form modal and beta disclaimer
      ...
      <main>
        ...
        <section className="pt-20 pb-0 text-center">
          <div className="container mx-auto px-4">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-[48px] font-bold mb-8 bg-gradient-to-r from-[#FFA726] via-[#FF1681] via-[#C939D6] to-[#7B5DFF] text-transparent bg-clip-text mx-auto inline-block leading-none" style={{ lineHeight: '1.3' }}>
            ...
            <Button
              size="lg"
              className="min-w-[200px] rounded-full bg-[#FFA726] text-white hover:bg-[#FF8A65] font-semibold shadow-[0_4px_8px_rgba(255,167,38,0.3)] hover:shadow-[0_6px_10px_rgba(255,167,38,0.4)] transition-all duration-200 hover:translate-y-[-2px] hover:scale-105"
              onClick={openBetaDisclaimer}
            >
              Try Beta Now
            </Button>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="mt-16 text-center">
              ...
              <Button
                size="lg"
                className="rounded-full bg-[#FFA726] text-white hover:bg-[#FF8A65] font-semibold shadow-lg px-8 py-6 hover:scale-105 transition-all duration-200"
                onClick={openBetaDisclaimer}
              >
                Try Beta Now
              </Button>
            ...
            <div className="mt-12 max-w-4xl mx-auto bg-gray-50 rounded-2xl p-6 sm:p-8">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="w-full md:w-1/3 mt-4 md:mt-0">
                  <Button
                    className="w-full bg-[#FFA726] text-white hover:bg-[#FF8A65] rounded-full px-4 sm:px-8 py-4 sm:py-6 font-semibold shadow-lg hover:scale-105 transition-all duration-200"
                    onClick={openBetaDisclaimer}
                  >
                    Try Beta Now
                  </Button>
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-3xl p-0 pb-8 shadow-lg overflow-hidden">
              <div className="text-center">
                ...
                <div className="px-8 pt-6">
                  ...
                  <Button
                    size="lg"
                    className="min-w-[200px] rounded-full bg-[#FFA726] text-white hover:bg-[#FF8A65] py-6 font-semibold shadow-[0_4px_8px_rgba(255,167,38,0.3)] hover:shadow-[0_6px_10px_rgba(255,167,38,0.4)] transition-all duration-200 hover:translate-y-[-2px] hover:scale-105"
                    onClick={openBetaDisclaimer}
                  >
                    Try Beta Now
                  </Button>
